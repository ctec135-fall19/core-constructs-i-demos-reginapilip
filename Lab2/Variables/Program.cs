...
namespace Variables
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int myInt;
            long myLong = 0;
            double myDouble = 0.0; //64 bit version of a float?
            ...
            Console.WriteLine("test 1 ==: {0}", hello == "hello2");
            Console.WriteLine("test 2 ==: {0}", hello == "hello");
            Console.WriteLine("test 3 ==: {0}", hello.Equals("Hello"));
